...
So yeah, my intent here is to create a To-do list app that haves an MVC architecture. Here it will be the PHP version, which later be compared to teh same project built with other tech solutions
